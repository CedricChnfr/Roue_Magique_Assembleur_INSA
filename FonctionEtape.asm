...
Capteur	PROC
			...
			AND R5, R4, #0x0100		; Vérifier si le bit 8 de l'adresse chargée dans R5 est à 1 ou à 0.
			;TST R4, #0x0100		; Vérifie si le bit 8 de R5 est à 1 ou à 0
			CMP R5, #0				; Compare R5 à zéro
			BEQ Allume_LED			; Si R5 est égal à zéro, saute à l'étiquette Allume_LED
			BNE Eteint_LED			; Si R5 est différent de zéro, saute à l'étiquette Eteint_LED. Avec R5 à 0x80 pour 8eme bit à 1
			BX LR
			ENDP
